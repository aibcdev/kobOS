...
export const AUTONOMY_STAGES = [
  ...
  },
  {
    ...
    name: "Ask",
    level: "ask" as AutonomyLevel,
    owner: "Always draft replies to 4 and 5 star reviews.",
    kob: "I'll draft in your usual tone.\nComplaints, refunds and prices still come to you. Posts wait for verify.",
    action: "Draft 4–5 star reviews",
  },
  {
    ...
    kob: "Two 5-star reviews came in after close. Drafts are ready — not posted until verified.\nOne wait complaint stays with you. No voucher offered.",
    action: undefined,
  },
  {
    id: "never" as const,
    name: "Never",
    level: "always-ask" as AutonomyLevel,
    owner: "Never change prices or offer vouchers.",
    kob: "Locked. Those jobs stay with you — I will not draft them unless you ask.",
    action: undefined,
  },
];
